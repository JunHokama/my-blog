...
global_variables() {
    ...
    # Blog title
    global_title="Eduardo Hokama"
    # The typical subtitle for each blog
    global_description="Reflexões, Lógica e Computação"
    # The public base URL for this blog
    global_url="http://example.com/blog"

    # Your name
    global_author="Eduardo Hokama"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://twitter.com/TeoLogIQ" 
    # Your email
    global_email="ejunhok@gmail.com"
